...
@section('container')
    ...
    <div class="row">
        ...
        <a href="{{route('register')}}" style="text-decoration: none"><div class="division" id="student"><h1>Student register</h1></div></a>
        <br>
        <a href="{{route('attendanceHome')}}" style="text-decoration: none;margin-left: 260px"><div class="division" id="attendance"><h1>Attendance</h1></div></a>
